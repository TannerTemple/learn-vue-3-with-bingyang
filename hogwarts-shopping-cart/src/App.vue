                ...
                <div class="cart-list-item">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="on-backorder-status" v-if="!shoppingCartItems[2].inStock"> 
                                <i class="fa-solid fa-hourglass-half"></i> On backorder</p>
                        </div>
                        <div class="item-actions">
                            <div class="quantity-selector">
                    ...
                    <div class="item-details-with-actions">
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                <input type="text" class="quantity-input" 
                                v-model.number="shoppingCartItems[3].quantity" aria-label="quantity"
                                >
                    ...
                    <div class="item-details-with-actions">
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                <input type="text" class="quantity-input" 
                                v-model.number="shoppingCartItems[4].quantity" aria-label="quantity"
                                >
